...
import Edu_work from '@/views/Education/courseware/Education_courseware-work.vue'
...
import Educatin_music_list from '@/views/Education/music/music_list.vue'   // 乐曲列表
import Educatin_music_special from '@/views/Education/music/music_special.vue'   // 专辑列表
import Educatin_music_add from '@/views/Education/music/music_add'  // 乐曲修改
import Educatin_music_special_add from '@/views/Education/music/music_special_add' // 专辑修改
...
let routes = [
...

    {
        ...
        children: [{
            ...
            {
                path: '/education/work', // 课件子列表-添加视频
                component: Edu_work,
            },
            {
                path: '/education/music_list', // 乐曲列表
                component: Educatin_music_list,
            },
            {
                path: '/education/special', // 专辑列表
                component: Educatin_music_special,
            },
            {
                path: '/education/music_add', // 乐曲修改
                component: Educatin_music_add,
            },
            {
                path: '/education/special_add', // 乐曲修改
                component: Educatin_music_special_add,
            },
        ],
        meta: {
            title: '',
