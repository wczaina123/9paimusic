...
<div class="mainbox" style="margin:30px 0;">
  ...
  <!--   <div class="minetoplink">
        <span style="margin-left:30px;color:#287AF2;" @click="addcourseclass">
...
methods:{
  exit() {  // 退出
    ...
    addcourseclass(){  // 增加
        this.$router.push({path:'/education/courseclassadd'})
    },

    addcourseclass_id(id){
        this.$router.push({path:'/education/courseclassadd'+'?'+id})
    },
