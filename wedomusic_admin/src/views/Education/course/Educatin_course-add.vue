...
<template>
    ...
    <div class="input_div">
        ...
        <span class="checkbox"><label><input type="checkbox" v-model="is_vip" :checked="is_buy" @change="video_buy">是</label></span>
    </div>
    <!-- <div class="input_div">
    ...
    <div class="input_div">
        <a class="table_a" style="float: left;">课程价格: </a>
        <Input placeholder="请输入课程价格" style="width: 300px" v-model="video_icon"></Input>
    </div>
    <div class="input_div">
        <a class="table_a" style="float: left;">会员价: </a>
        <Input placeholder="请输入会员价" style="width: 300px" v-model="vip_coin"></Input>
    </div>
    <!-- <div class="input_div">
        <a class="table_a" style="float: left;">课程价格: </a>
        <div>
            <RadioGroup v-model="vertical" @on-change='vertical_change'>
                <Radio label="vip">
                    <span >仅会员可见</span>
                    <br>
                    <div v-if="vertical_vip">
                        <span style="padding:0 15px">会员价格：</span><Input placeholder="请输入会员价格(免费为0)" style="width: 200px" ></Input>
                    </div>
                    
                </Radio>
                <br>
                <Radio label="all">
                    <span>全部可见 &nbsp&nbsp</span>
                    <br>
                    <div v-if="vertical_all">
                        <span style="padding:0 15px">课程价格：</span><Input placeholder="请输入课程价格(免费为0)" style="width: 200px" ></Input>
                        <br>
                        <br>
                        <span style="padding:0 15px">会员价格：</span><Input placeholder="请输入会员价格(免费为0)" style="width: 200px" ></Input>                    
                    </div>
    ...
    <!-- <div class="input_div">
        <a class="table_a" style="float: left;">课程价格: </a>
        <Input placeholder="请输入课程价格" style="width: 300px" v-model="video_name"></Input>
    </div>
    <div class="input_div">
        <a class="table_a" style="float: left;">会员价: </a>
        <Input placeholder="请输入会员价" style="width: 300px" v-model="video_name"></Input>
    </div> -->
    <div class="input_div">
...
methods:{
    ...
    vertical_change(){   // 选择课程价格
        if(this.vertical=='vip'){
            this.vertical_vip = true
            this.vertical_all = false
        }
        if(this.vertical=='all'){
            this.vertical_vip = false
            this.vertical_all = true
        }
    },
