	...
	<div id="comment">
		...
		<div id="app2">
			<Modal width="400" v-model="up_class" class-name="vertical-center-modal">
				...
				<p style="" v-for="res in new_weak_ids" :key="res.weak_id">
	...
	export default {
		...
		methods:{
			...
			add_time(){
				...
				this.weak_ids = arr
				// this.newweak_ids = arr
				// console.log(this.weak_ids,'22222')
			...
			get_start_data(data){  // 开班日期
				this.star_data = data
				// console.log(this.star_data)
			},

			get_teaching_data(data){  // 上课时间 （数组）
				this.teaching_data = data
				console.log(this.teaching_data)
			},
			...
			add_class(){  // 新增
			console.log(this.weak_ids,'sadsdjasdja')
				this.$axios({
