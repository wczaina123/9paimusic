                    ...
                    <table class="table-list">
                        <thead>
                            <tr>
                                ...
                                <th v-for="(res,index) in 5" :key="res.id" style="width:15%;">商品{{index+1}}名称</th>
                                <!-- <th style="width:5%;">商品1名称</th> -->
                                <!-- <th style="width:5%;">商品2名称</th> -->
                                <!-- <th style="width:5%;">商品3名称</th> -->
                        ...
                        <tbody>
                            <tr v-for="res in list_main" :key="res.id">
                                ...
                                <!-- <td style="text-align:center;">{{res.content[0].name}}</td> -->
                                <!-- <td style="text-align:center;">{{res.content[1].name}}</td> -->
                                <!-- <td style="text-align:center;">{{(res.content[2].name)?(res.content[2].name):'/'}}</td> -->
                ...
                <div>
                    <Modal width="600" v-model="addtc" class-name="vertical-center-modal">
                        ...
                        <div style="padding-top=20px;">
                            ...
                            <div style="padding:0 0 20px 0">
                                <span style="font-size: 14px;color: #363F4C; margin:0 19px 20px 20px">商品总价:{{sum}}元</span>
                            </div>
                            <div style="padding:0 0 20px 0">
    ...
    computed:{
        sum(){    // 计算套餐的总和
            ...
            for(let i=0;i<this.goods_arr.length;i++){
                a =  Number(this.goods_arr[i].price) + Number(a)
            }
            return a
        },
    },
        ...
        get_list() {   // 套餐列表
            this.$axios({
                ...
                .then(res => {
                    ...
                    for (let i = 0; i < this.list_main.length; i++) {  // 补足5个商品（未来可替代）
                        for(let b=0;b<5;b++){
                            if(this.list_main[i].content.length>=5){
                                break;
                            } 
                            let obj = {name:'/'}
                            this.list_main[i].content.push(obj)  
                        } 
                    }
                })
        },
