...
// },
watch:{
    list_main(new_val,old_val){
        console.log(new_val,old_val,'1111')
    }
},
...
methods:{
    ...
    get_list(){  // 商品列表
        ...
        .then(res=>{
            ...
            //             // console.log(this.category_list[l].name,'this.category_list[l].name' )
            //             a[i].category_name = this.category_list[l].name
            //             // this.$set(this.list_main[i],'category_name',this.category_list[l].name)
            //         }
            //     }
            // }
            // this.list_main = a
            // console.log(this.list_main)
